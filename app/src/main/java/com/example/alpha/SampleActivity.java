...
public class SampleActivity extends BaseActivity implements UCropFragmentCallback {
    ...
    private static final String SAMPLE_CROPPED_IMAGE_NAME = "ProjectAlphaX";
    int i;
    ...
    private int requestMode = RequestMode;
        ...
        if (resultCode == RESULT_OK) {
            if (requestCode == requestMode) {
                ...
                if (selectedUri != null) {
                    ...
                    Toast.makeText(SampleActivity.this, "Cannot Retrieve", Toast.LENGTH_SHORT).show();
                }
