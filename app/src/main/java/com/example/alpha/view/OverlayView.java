...
import com.example.alpha.callback.OverlayViewChangeListener;
import com.example.alpha.util.RectUtils;
...
//        }
    ...
    protected void processStyledAttributes(@NonNull TypedArray a) {
        mCircleDimmedLayer = a.getBoolean(com.yalantis.ucrop.R.styleable.ucrop_UCropView_ucrop_circle_dimmed_layer, DEFAULT_CIRCLE_DIMMED_LAYER);
        mDimmedColor = a.getColor(com.yalantis.ucrop.R.styleable.ucrop_UCropView_ucrop_dimmed_color,
        ...
        mShowCropFrame = a.getBoolean(com.yalantis.ucrop.R.styleable.ucrop_UCropView_ucrop_show_frame, DEFAULT_SHOW_CROP_FRAME);

        initCropGridStyle(a);
        mShowCropGrid = a.getBoolean(com.yalantis.ucrop.R.styleable.ucrop_UCropView_ucrop_show_grid, DEFAULT_SHOW_CROP_GRID);
    }
    ...
    private void initCropFrameStyle(@NonNull TypedArray a) {
        int cropFrameStrokeSize = a.getDimensionPixelSize(com.yalantis.ucrop.R.styleable.ucrop_UCropView_ucrop_frame_stroke_size,
                getResources().getDimensionPixelSize(com.yalantis.ucrop.R.dimen.ucrop_default_crop_frame_stoke_width));
        int cropFrameColor = a.getColor(com.yalantis.ucrop.R.styleable.ucrop_UCropView_ucrop_frame_color,
                getResources().getColor(com.yalantis.ucrop.R.color.ucrop_color_default_crop_frame));
    ...
    private void initCropGridStyle(@NonNull TypedArray a) {
        int cropGridStrokeSize = a.getDimensionPixelSize(com.yalantis.ucrop.R.styleable.ucrop_UCropView_ucrop_grid_stroke_size,
                getResources().getDimensionPixelSize(com.yalantis.ucrop.R.dimen.ucrop_default_crop_grid_stoke_width));
        int cropGridColor = a.getColor(com.yalantis.ucrop.R.styleable.ucrop_UCropView_ucrop_grid_color,
        ...
        mCropGridRowCount = a.getInt(com.yalantis.ucrop.R.styleable.ucrop_UCropView_ucrop_grid_row_count, DEFAULT_CROP_GRID_ROW_COUNT);
        mCropGridColumnCount = a.getInt(com.yalantis.ucrop.R.styleable.ucrop_UCropView_ucrop_grid_column_count, DEFAULT_CROP_GRID_COLUMN_COUNT);
    }
