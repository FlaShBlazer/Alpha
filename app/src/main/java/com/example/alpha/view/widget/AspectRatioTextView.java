package com.example.alpha.view.widget;
...
public class AspectRatioTextView extends AppCompatTextView {
    ...
    public AspectRatioTextView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, com.yalantis.ucrop.R.styleable.ucrop_AspectRatioTextView);
        init(a);
    }
    ...
    private void init(@NonNull TypedArray a) {
        ...
        mAspectRatioTitle = a.getString(com.yalantis.ucrop.R.styleable.ucrop_AspectRatioTextView_ucrop_artv_ratio_title);
        mAspectRatioX = a.getFloat(com.yalantis.ucrop.R.styleable.ucrop_AspectRatioTextView_ucrop_artv_ratio_x, CropImageView.SOURCE_IMAGE_ASPECT_RATIO);
        mAspectRatioY = a.getFloat(com.yalantis.ucrop.R.styleable.ucrop_AspectRatioTextView_ucrop_artv_ratio_y, CropImageView.SOURCE_IMAGE_ASPECT_RATIO);
        ...
        mDotSize = getContext().getResources().getDimensionPixelSize(com.yalantis.ucrop.R.dimen.ucrop_size_dot_scale_text_view);
        mDotPaint = new Paint(Paint.ANTI_ALIAS_FLAG);
        mDotPaint.setStyle(Paint.Style.FILL);

        setTitle();

        int activeColor = getResources().getColor(com.yalantis.ucrop.R.color.ucrop_color_widget_active);
        applyActiveColor(activeColor);
    ...
    private void applyActiveColor(@ColorInt int activeColor) {
        ...
        ColorStateList textViewColorStateList = new ColorStateList(
                ...
                new int[]{
                        activeColor,
                        ContextCompat.getColor(getContext(), com.yalantis.ucrop.R.color.ucrop_color_widget)
                }
        );
