...
public class UCropView extends FrameLayout {
    ...
    public UCropView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        LayoutInflater.from(context).inflate(com.example.alpha.R.layout.ucrop_view, this, true);
        mGestureCropImageView = findViewById(com.example.alpha.R.id.image_view_crop);
        mViewOverlay = findViewById(com.example.alpha.R.id.view_overlay);

        TypedArray a = context.obtainStyledAttributes(attrs, com.example.alpha.R.styleable.ucrop_UCropView);
    ...
    @NonNull
    public com.example.alpha.view.GestureCropImageView getCropImageView() {
        return mGestureCropImageView;
    }

    @NonNull
    public com.example.alpha.view.OverlayView getOverlayView() {
        return mViewOverlay;
    }
