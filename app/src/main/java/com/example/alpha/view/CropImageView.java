...
import com.example.alpha.Model.CropParameters;
import com.example.alpha.Model.ImageState;
import com.example.alpha.callback.BitmapCropCallback;
import com.example.alpha.callback.CropBoundsChangeListener;
import com.example.alpha.task.BitmapCropTask;
import com.example.alpha.util.CubicEasing;
...
public class CropImageView extends TransformImageView {
    ...
    public void setImageToWrapCropBounds(boolean animate) {
        if (mBitmapLaidOut && !isImageWrapCropBounds()) {
            ...
            if (animate) {
                post(mWrapCropBoundsRunnable = new WrapCropBoundsRunnable(CropImageView.this, mImageToWrapCropBoundsAnimDuration, currentX, currentY, deltaX, deltaY,
    ...
    protected void zoomImageToPosition(float scale, float centerX, float centerY, long durationMs) {
        ...
        post(mZoomImageToPositionRunnable = new ZoomImageToPosition(com.example.alpha.view.CropImageView.this,
    ...
    protected void processStyledAttributes(@NonNull TypedArray a) {
        float targetAspectRatioX = Math.abs(a.getFloat(com.yalantis.ucrop.R.styleable.ucrop_UCropView_ucrop_aspect_ratio_x, DEFAULT_ASPECT_RATIO));
        float targetAspectRatioY = Math.abs(a.getFloat(com.yalantis.ucrop.R.styleable.ucrop_UCropView_ucrop_aspect_ratio_y, DEFAULT_ASPECT_RATIO));
    ...
    private static class WrapCropBoundsRunnable implements Runnable {
        ...
        @Override
        public void run() {
            com.example.alpha.view.CropImageView cropImageView = mCropImageView.get();
    ...
    private static class ZoomImageToPosition implements Runnable {
        ...
        public ZoomImageToPosition(com.example.alpha.view.CropImageView cropImageView,
                                   long durationMs,
                                   float oldScale, float deltaScale,
