...
public class HorizontalProgressWheelView extends View {
    ...
    private void init() {
        mMiddleLineColor = ContextCompat.getColor(getContext(), com.yalantis.ucrop.R.color.ucrop_color_widget_rotate_mid_line);

        mProgressLineWidth = getContext().getResources().getDimensionPixelSize(com.yalantis.ucrop.R.dimen.ucrop_width_horizontal_wheel_progress_line);
        mProgressLineHeight = getContext().getResources().getDimensionPixelSize(com.yalantis.ucrop.R.dimen.ucrop_height_horizontal_wheel_progress_line);
        mProgressLineMargin = getContext().getResources().getDimensionPixelSize(com.yalantis.ucrop.R.dimen.ucrop_margin_horizontal_wheel_progress_line);
        ...
        mProgressLinePaint.setColor(getResources().getColor(com.yalantis.ucrop.R.color.ucrop_color_progress_wheel_line));
        ...
        mProgressMiddleLinePaint.setStrokeWidth(getContext().getResources().getDimensionPixelSize(com.yalantis.ucrop.R.dimen.ucrop_width_middle_wheel_progress_line));
    }
